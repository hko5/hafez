...
<body>
    <center>
        <div class="main">
            <form action="adlogin.php" method="post" enctype="multipart/form-data">
                <h2>Admin Page</h2>
                ...
                <input type="text" name='check' readonly style="border:0px solid #a39276; background-color:#a39276; color:red;" value="<?php echo $ans; ?>">
